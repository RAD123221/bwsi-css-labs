...
def main():
    ...
    name = "Raghav" # TODO: Insert your name between the double quotes

    print(f"{name}, Welcome to the CSS course!")
    print("Hi everyone, my name is Raghav, and I am a junior from Massachusetts. I like to hike and sail in my free time. I look forward to learning more about Git and computer systems.")
